 ...
 * @author Groupe Anok
 */
public class userDevalideServlet extends HttpServlet {
       ...
       ((HttpServletResponse) response).addHeader("Access-Control-Allow-Origin", "*");
        ...
        for (Operateur op1 : op) {
            if (op1.getIdgroupe().getIdgroupe().equals("PRO")) {
                ...
                b.setCh11(op1.getIdgroupe().getIdgroupe());
                try {
                    b.setCh12(op1.getAssociation().getNomAssoc());
                } catch (NullPointerException e) {
                    b.setCh12("Aucune");
                }
                b.setCh13(op1.getIdgroupe().getGroupe());
                userdata.add(b);
            }
        }
